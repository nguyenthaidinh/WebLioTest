...
<head>
    ...
    <title>Admin Panel - Code by Lio</title>
...
<body>
    <div class="container color-forum pt-1 pb-1">
        <div class="row">
            <div class="col"> <a href="/forum.php" style="color: white">Quay lại diễn đàn</a> </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                ...
                <div class="text-center mb-2">
                    ...
                    <a class="btn btn-main btn-sm" href="/admin/users.php">NGƯỜI DÙNG</a>
                    <a class="btn btn-main btn-sm" href="/admin/players.php">NHÂN VẬT</a>
                </div>
            ...
            <div class="col">
                <div class="text-center">
                    <div style="font-size: 13px" class="text-muted">
                                    ...
                                    <small style="background:linear-gradient(135deg,#f97316,#febb12);color:#000;font-weight:800;padding:2px 10px;border-radius:4px;font-size:10px;text-transform:uppercase;display:inline-block;margin-top:5px;">Code by Lio</small>
                                </div>
                            </div>
                </div>
            </div>
